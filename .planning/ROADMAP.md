...
**Success Criteria** (what must be TRUE):
  ...
  5. Reading `.claude/skills/write-notion-report/SKILL.md` frontmatter in isolation, Claude knows to invoke the Skill when handed a completed analyzer report dictionary
**Plans:** TBD
